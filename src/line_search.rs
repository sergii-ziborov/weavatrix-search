...
impl LineSearcher {
    ...
    fn warn_replacement_limit(&mut self) {
    ...
    fn render_replacement(&mut self, line: &[u8], query_cache: &mut QueryCache) -> Option<String> {
...
fn render_line(line: &[u8]) -> (String, bool) {
